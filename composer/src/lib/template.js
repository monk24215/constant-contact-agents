...
<body style="margin:auto;padding:0;max-width:600px;width:100%;background-color:#ffffff;color:#333;font-family:PT Sans,Roboto,Arial,sans-serif;line-height:2em;font-size:17.5px;font-weight:400;">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#ffffff;">
  <tr>
    <td align="center" style="padding:15px 18px;">
      <table width="650" align="center" border="0" cellpadding="0" cellspacing="0" style="width:100%;max-width:650px;margin:auto;padding:0;max-width:600px;width:100%;background-color:#ffffff;color:#333;font-family:PT Sans,Roboto,Arial,sans-serif;line-height:2em;font-size:17.5px;font-weight:400;background-color:#ffffff;">
        <tr>
          <td align="left" style="margin:auto;padding:0;max-width:600px;width:100%;background-color:#ffffff;color:#333;font-family:PT Sans,Roboto,Arial,sans-serif;line-height:2em;font-size:17.5px;font-weight:400;word-wrap:break-word;padding:50px 30px;">${bodyHtml}
          <p>&nbsp;</p>  <p>&nbsp;</p>
          </td>
        </tr>
